...
`comprepfor` objects are also compatible with the S3 method `plot`, which can be used to generate a heatmap illustrating the field trial, and box-plots with each candidate's performance. 
